...
const pictureList = [
  ...
  { img: 'https://user-images.githubusercontent.com/11402468/58957575-d1441b80-87db-11e9-956b-a69266304f9b.jpg' },
  {
    img:
  ...
  { img: 'https://user-images.githubusercontent.com/11402468/58957582-d43f0c00-87db-11e9-92db-b4037d423b88.jpg' },
];
...
storiesOf('Gallery', module)
  .add('Gallery', () => (
    <div style={{ padding: '20px' }}>
      <Gallery pictureList={pictureList} onClickPhoto={handleClickPhoto}/>
    </div>
  ))
  .add('Photo - 사진', () => (
    <>
